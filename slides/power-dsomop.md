...
<path class="fed-line fed-up" :class="{ show: $clicks >= 1 && $clicks < 3 }" d="M50,67 C42,52 25,40 17,22" /><path class="fed-line fed-up" :class="{ show: $clicks >= 1 && $clicks < 3 }" d="M50,67 L50,22" /><path class="fed-line fed-up" :class="{ show: $clicks >= 1 && $clicks < 3 }" d="M50,67 C58,52 75,40 83,22" />
<path class="fed-line fed-down" :class="{ show: $clicks >= 3 }" d="M17,22 C25,40 42,52 50,67" /><path class="fed-line fed-down" :class="{ show: $clicks >= 3 }" d="M50,22 L50,67" /><path class="fed-line fed-down" :class="{ show: $clicks >= 3 }" d="M83,22 C75,40 58,52 50,67" />
</svg>
